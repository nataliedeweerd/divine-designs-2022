...
export class Grid {
    ...
    showContent(gridItem) {
        ...
        //this.classList.add('hereiam');
        const imageTransform = this.calcTransformImage();


        console.log(adjustedBoundingRect(gridItem.DOM.img.outer));
        console.log(imageTransform.scale);

        let largeBox = adjustedBoundingRect(gridItem.DOM.img.outer);
        let outerW = largeBox.width * imageTransform.scale;
        ...
        this.timeline
            ...
            .add(() => {
                ...
                gridItem.contentItem.DOM.el.style.width = outerW + "px";
        ...
        //document.querySelector('.content__item').width = outerW+"px";
    ...
    getFinalScaleValue(gridItemImageOuter) {
        return 0 / gridItemImageOuter.offsetHeight;
    }
    ...
    getFinalTranslationValue(gridItemImageOuter, position) {
        ...
        return {
            x: (0 / 2) - (imgrect.left + imgrect.width / 2),
            y: (0 / 2) - (imgrect.top + imgrect.height / 2)
        };
    }
    ...
    calcTransformImage() {
        ...
        // work out ratio
        // output it at same ratio as scale.
